...
import 'package:personal_expense_tracker/home/tabs/dashboard/widgets/expenditure_chart.dart';
import 'package:personal_expense_tracker/home/tabs/dashboard/widgets/income_chart.dart';
...
class _IncomeSection extends StatelessWidget {
  const _IncomeSection({super.key});
...
class _ExpenditureSection extends StatelessWidget {
  const _ExpenditureSection({super.key});
...
class _RevenueHistorySection extends StatelessWidget {
  const _RevenueHistorySection({super.key});
