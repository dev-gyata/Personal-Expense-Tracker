...
void main() {
  ...
  group('LoginView', () {
    ...
    testWidgets(
        'Verify that screen  renders email invalid error when email entered is invalid',
        (tester) async {
    ...
    testWidgets(
        'Verify that screen renders password invalid error when password entered'
        ' is invalid', (tester) async {
      const state = LoginState(
